# Cox Model 2, any source (HOS,OPD,MED): separate modesl for men and women, no adjustment for psychiatric comorbidities
...
# Run time when analyzing all exposures: ~15 minutes   
...
which_mhd<- c("first_any_admission","first_any_admission_organic","first_any_admission_substance_use_disorder","first_any_admission_psychotic",
              ...
              "first_any_admission_alcohol_use_disorder","first_any_admission_drug_use_disorder","first_any_admission_bipolar","first_any_admission_depression",
              "first_any_admission_generalised_anxiety_disorder","first_any_admission_PTSD","first_any_admission_eating_disorder")
...
write_xlsx(df_aHRs,path=file.path(filepath_tables,paste0("aHRs_model2_any_admission.xlsx")))
save(creg_list_ac,file=file.path(filepath_write,"obj_model2_ac_any_admission.RData"))
save(creg_list_nd,file=file.path(filepath_write,"obj_model2_nd_any_admission.RData"))
save(creg_list_ud,file=file.path(filepath_write,"obj_model2_ud_any_admission.RData"))
