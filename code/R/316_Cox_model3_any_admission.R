# Cox Model 3, any source (HOS,OPD,MED): all exposures in one model, adjusted for sex
...
write_xlsx(df_aHRs,path=file.path(filepath_tables,paste0("aHRs_model3_any_admission.xlsx")))
save(creg_list_ac,file=file.path(filepath_write,"obj_model3_ac_any_admission.RData"))
save(creg_list_nd,file=file.path(filepath_write,"obj_model3_nd_any_admission.RData"))
save(creg_list_ud,file=file.path(filepath_write,"obj_model3_ud_any_admission.RData"))
