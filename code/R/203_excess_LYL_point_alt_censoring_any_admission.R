# point estimates for excess life-years lost with alternate censoring strategy, any admission type
# output: R table "elyl_alt_censoring_any_admission.RData"
# 2+ hours with all exposures, men + women separately
...
save_filename <- "elyl_alt_censoring_any_admission.RData"

load(file=paste(filepath_read,"/long_table_alt_censoring.RData",sep=''))
