# Cox Model 1, medications (MED_ATC_N): combining men and women, no adjustment for psychiatric comorbidities
...
write_xlsx(df_aHRs,path=file.path(filepath_tables,"aHRs_model1_med.xlsx"))
save(creg_list_ac,file=file.path(filepath_write,"obj_model1_ac_med.RData"))
save(creg_list_nd,file=file.path(filepath_write,"obj_model1_nd_med.RData"))
save(creg_list_ud,file=file.path(filepath_write,"obj_model1_ud_med.RData"))
