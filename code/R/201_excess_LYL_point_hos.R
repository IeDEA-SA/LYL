# point estimates for excess life-years lost, hospital admissions
# output: R table "elyl_any_hos.RData"
#  ~5 hours with all exposures
...
which_mhd <- c("first_hos_any","first_hos_organic","first_hos_substance_use_disorder","first_hos_alcohol_use_disorder","first_hos_drug_use_disorder",
               ...
               "first_hos_PTSD","first_hos_asc_developmental_disorders","first_hos_asc_behavioural_disorders","first_hos_asc_physical_factors",
               "first_hos_eating_disorder","first_hos_asc_personality_disorder" )
which_sex <- c("Men","Women")

min_age <- 15
max_age <- 85

save_filename <- "elyl_hos.RData"
