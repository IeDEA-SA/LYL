...
write_xlsx(df_aHRs,path=file.path(filepath_tables,"aHRs_model1_any_admission.xlsx"))
save(creg_list_ac,file=file.path(filepath_write,"obj_model1_ac_any_admission.RData"))
save(creg_list_nd,file=file.path(filepath_write,"obj_model1_nd_any_admission.RData"))
save(creg_list_ud,file=file.path(filepath_write,"obj_model1_ud_any_admission.RData"))
