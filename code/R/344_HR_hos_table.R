# produces tables of hazard ratios, hospitalizations
...
mod1 <- data.table(read_xlsx(file.path(filepath_read,"aHRs_model1_hos.xlsx")))
mod2 <- data.table(read_xlsx(file.path(filepath_read,"aHRs_model2_hos.xlsx")))
mod3 <- data.table(read_xlsx(file.path(filepath_read,"aHRs_model3_hos.xlsx")))
mod4 <- data.table(read_xlsx(file.path(filepath_read,"aHRs_model4_hos.xlsx")))
...
full_table[,`:=`(HRu=gsub("\\.","·",HRu),
                 HRa=gsub("\\.","·",HRa),
                 p_val=gsub("\\.","·",p_val))]
write_xlsx(full_table,file.path(filepath_write,"aHRs_hos_table.xlsx"))
