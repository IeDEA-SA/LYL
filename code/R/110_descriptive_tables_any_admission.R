# descriptive tables, any hopsital admission
...
which_mhd <- c("first_any_admission","first_any_admission_organic","first_any_admission_substance_use_disorder","first_any_admission_alcohol_use_disorder",
               ...
               "first_any_admission_asc_developmental_disorders","first_any_admission_eating_disorder","first_any_admission_asc_personality_disorder")
...
for(v in which_mhd)
{
  ...
  if(v=="first_any_admission")   # creating single table with/without mental illness
  {
    ...
    write_xlsx(overall_df,path=file.path(filepath_write,"descriptive_overall_any_admission.xlsx"))
  }
...
MHD_count_df[,`:=`(men=gsub("\\.","·",men),
                   women=gsub("\\.","·",women),
                   total=gsub("\\.","·",total))]
write_xlsx(MHD_count_df,path=file.path(filepath_write,"descriptive_by_MHD_and_sex_any_admission.xlsx"))
